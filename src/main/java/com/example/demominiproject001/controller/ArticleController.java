...
public class ArticleController {
    ...
    @Operation(summary = "Comment on specific article")
    public ResponseEntity<ApiResponse<ArticleDTO>> createCommentOnArticle(){
        return ResponseEntity.status(HttpStatus.CREATED).body(ApiResponse.success("Comment successfully", null));
    }
}
